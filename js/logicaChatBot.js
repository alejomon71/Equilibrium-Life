let emocionActual = '';
        ...
        function enviarMensaje() {
            ...
            const patronesRespuestas = {
                ...
                tristeza: /triste|Triste|Tristeza|masamorra/,
            ...
            const respuestas = {
                hola: 'Hola grupo ¿Como estas?',
                bien: 'Me alegra saber que estás bien. ¿En qué puedo ayudarte?',
                felicidad: 'La felicidad es un estado emocional positivo que se caracteriza por sentimientos de alegría, satisfacción y bienestar.<br> Es importante cultivar momentos de felicidad en nuestra vida diaria. ¿Te gustaría obtener más información sobre la felicidad?<br> <a href="https://es.knowablemagazine.org/content/articulo/mente/2024/cientificos-examinan-investigacion-sobre-felicidad" target="_blank">Más Información</a>',
                tristeza: 'La tristeza es una emoción normal que todos experimentamos. Puede ser causada por pérdidas, decepciones o situaciones difíciles. <br> Es esencial permitirnos sentir y procesar esta emoción. ¿Te gustaría obtener más información sobre la tristeza? <br> <a href="https://www.revistas.unam.mx/index.php/repi/article/view/34739" target="_blank">Más Información</a>',
                ...
                desesperacion: 'La desesperación puede ser abrumadora y a menudo requiere apoyo. Es importante buscar ayuda si te sientes atrapado en un ciclo de desesperanza. ¿Te gustaría obtener más información sobre este estado de ánimo? <br> <a href="https://revistas.upsa.es/index.php/cuadernossalmantinos/article/view/562/433">Más Información</a>',
